...
const routes: Routes = [
  ...
  { path: 'choix_du_profil', component: ChoiceProfilComponent },
  { path: 'choix_du_profil_diplome', component: ChoiceProfilDiplomeComponent },
  { path: 'creer_ecole', component: CreerEcoleComponent },
  { path: 'home', component: HomeComponent },
  { path: 'verify_product', component: SideBarProductComponent },
  { path: 'ajout_etudiant', component: StudentComponent, canActivate: [AuthGuard] },
